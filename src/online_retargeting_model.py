...
class EncoderDecoderGRU(object):
  def __init__(self, batch_size, alpha, gamma, omega, euler_ord, n_joints,
    ...
    if is_train:
      ...
      local_sum = tf.summary.scalar(
          "losses/local_loss", self.local_loss
      )
      global_sum = tf.summary.scalar(
          "losses/global_loss", self.global_loss
      )
      ...
      self.sum = tf.summary.merge([local_sum, global_sum,
